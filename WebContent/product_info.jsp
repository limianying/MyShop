...
<script type="text/javascript">
	function addToCart(){
		...
		location.href = "${pageContext.request.contextPath}/addToCart?pid=${productInfo.pid}&buyNum="+buyNum;
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						商城价: <strong style="color: #ef0101;">￥：${productInfo.market_price }元/份</strong> 参 考 价：
						<del>￥${productInfo.shop_price }元/份</del>
					</div>
					...
					<div>
					<a href = "${pageContext.request.contextPath}/productList?pid=${productInfo.pid}&currentPage=${currentPage }&cid=${cid}">返回列表页面</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
