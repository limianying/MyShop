...
<HTML>
	...
	<script type="text/javascript">
		window.onload = function(){
			...
			var isHot = "${product.is_hot}";
			var IsHotoptions= document.getElementById("is_hot").getElementsByTagName("option");
			for(var j = 0;j < IsHotoptions.length;j++){
				if(isHot == IsHotoptions[j].value){
					IsHotoptions[j].selected = true;
				}
			}
		}
