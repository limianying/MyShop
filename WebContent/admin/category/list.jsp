...
<script type="text/javascript">
			...
			function delCategory(cid){
				if(confirm("您确定要删除吗？")){
					location.href = "${pageContext.request.contextPath}/deleteCategory?cid="+cid;
				}
			}
</script>
</HEAD>
					...
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<tr onmouseover="this.style.backgroundColor = 'white'"
							onmouseout="this.style.backgroundColor = '#F5FAFE';">
								...
								<td style="CURSOR: hand; HEIGHT: 30px" align="center"
									width="17%">${categoryList.cname }</td>
								<td align="center" style="HEIGHT: 30px">
								<a href="${pageContext.request.contextPath }/findCategoryUI?cid=${categoryList.cid}">
								<img src="${pageContext.request.contextPath}/images/i_edit.gif"
										border="0" style="CURSOR: hand">
								</a></td>

								<td align="center" style="HEIGHT: 30px">
								<a href="javascript:void(0);" onclick = "delCategory('${categoryList.cid}')"> 
